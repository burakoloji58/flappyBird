...
import com.example.flappybird.databinding.ActivityOyunEkraniBinding
...
class OyunEkraniActivity : AppCompatActivity() {
    ...
    fun baslangicYaziSilme(){
        val alphAnimasyonu = ObjectAnimator.ofFloat(ulas.textViewBaslamakIcNDokun,"alpha",1.0f,0.0f).apply {
            duration = 500
        }
